...
import {default as GoogleMap} from "https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true";
	...
	render() {
		return <Layout>
			<div  id="address">
				...
				<div id="frmholder">
					<div id="map-form">
						<span class="address-lable">From:</span>
						<input type="search" size="25" id="end" placeholder="Enter your address here"/>
						<span class="address-lable">To Dutch Delight:</span>
